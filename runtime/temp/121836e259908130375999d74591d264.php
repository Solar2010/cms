<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\Ian\wamp\www\cms\public/../application/admin\view\model\lst.html";i:1555977860;s:58:"D:\Ian\wamp\www\cms\application\admin\view\public\top.html";i:1535515250;s:59:"D:\Ian\wamp\www\cms\application\admin\view\public\left.html";i:1556496660;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加栏目" class="btn btn-sm btn-azure btn-addon" onClick='javascript:window.location.href="<?php echo url('Model/add'); ?>"'>
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr >
                                            ...
                                            <td class="text-center"><?php echo $prefix; ?><?php echo $vo['table_name']; ?></td>
                                            <td class="text-center">
                                                <?php if($vo['status'] == 1): ?>
                                                <a href="javascript:;" data-id="<?php echo $vo['id']; ?>" class="btn btn-primary btn-sm shiny" onclick="changeStatus(this)">启用</a>

                                                <?php else: ?>
                                                <a href="javascript:;" data-id="<?php echo $vo['id']; ?>" class="btn btn-danger btn-sm shiny" onclick="changeStatus(this)">禁用</a>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="#" onclick="del(this)" class="btn btn-danger btn-sm shiny" id="<?php echo $vo['id']; ?>" table="<?php echo $vo['table_name']; ?>">
