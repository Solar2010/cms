<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\Ian\wamp\www\cms\public/../application/admin\view\category\edit.html";i:1556121119;s:58:"D:\Ian\wamp\www\cms\application\admin\view\public\top.html";i:1535515250;s:59:"D:\Ian\wamp\www\cms\application\admin\view\public\left.html";i:1556496660;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                                            ...
                                            <div class="tab-content  tabs-flat">
                                                <div class="active tab-pane" id="FlatTab-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select name="mode_id" class="form-control">
                                                                ...
                                                                <option value="<?php echo $model['id']; ?>" <?php if($model['id'] == $result['mode_id']): ?> selected="selected"<?php endif; ?>><?php echo $model['model_name']; ?></option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select name="pid" id="" class="form-control">
                                                                ...
                                                                <option value="<?php echo $categorys['id']; ?>" <?php if($result['pid'] == $categorys['id']): ?> selected="selected" <?php endif; ?>><?php echo str_repeat('-',$categorys['level']*3);?><?php echo $categorys['cate_name']; ?></option>
                                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                                            </select>
                                                        </div>
                                                        <p class="help-block col-sm-4 red">* 必填</p>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" name="cate_name" value="<?php echo $result['cate_name']; ?>">
                                                        </div>
                                                        <p class="help-block col-sm-4 red">* 必填</p>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input class="checkbox-slider  colored-blue" <?php if($result['status'] == 1): ?> checked="checked" <?php endif; ?> name="status" type="checkbox" value="1">
                                                    ...
                                                    <div class="form-group" id="cateimgdiv" <?php if($result['img'] != ''): ?>style="display: block"<?php endif; ?>>
                                                        <label class="col-sm-2 control-label no-padding-right"></label>
                                                        <div class="col-sm-6">
                                                            <div id="cateimg">
                                                                <?php if($result['img'] != ''): ?>
                                                                <img src="/cms/public/uploads/admin/category/<?php echo $result['img']; ?>" alt="" height="100">
                                                                <?php endif; ?>
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="radio" style="float: left">
                                                                <label><input <?php if($result['cate_attr'] == 1): ?>checked="checked"<?php endif; ?> name="cate_attr" type="radio" value="1">
                                                            ...
                                                            <div class="radio" style="float: left;padding-left: 10px">
                                                                <label><input <?php if($result['cate_attr'] == 3): ?>checked="checked"<?php endif; ?> name="cate_attr" type="radio" value="3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input <?php if($result['cate_attr'] == 3): ?>checked="checked"<?php endif; ?> type="text" class="form-control" value="<?php echo $result['list_tmp']; ?>" name="list_tmp">
                                                        </div>
                                                        <p class="help-block col-sm-4 red">* 必填</p>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" value="<?php echo $result['index_tmp']; ?>" name="index_tmp">
                                                        </div>
                                                        <p class="help-block col-sm-4 red">* 必填</p>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" value="<?php echo $result['article_tmp']; ?>" name="article_tmp">
                                                        </div>
                                                        <p class="help-block col-sm-4 red">* 必填</p>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" value="<?php echo $result['link']; ?>" name="link">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="FlatTab-2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <textarea name="desc" class="form-control"><?php echo $result['desc']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
