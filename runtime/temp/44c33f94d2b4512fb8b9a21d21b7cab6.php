    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加栏目" class="btn btn-sm btn-azure btn-addon" onClick='javascript:window.location.href="<?php echo url('Category/add'); ?>"'>
                        ...
                        <div class="widget">
                            <div class="widget-body">
                                <div class="flip-scroll">
                                    <form method="post" action="<?php echo url('delAndSort'); ?>">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr id="<?php echo $vo['id']; ?>" pid="<?php echo $vo['pid']; ?>">
                                                ...
                                                <td align="center">
                                                    <label>
                                                        <input type="checkbox" class="colored-blue" name="item[]" value="<?php echo $vo['id']; ?>">
                                                        <span class="text"></span>
                                                    </label>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo url('Content/lst',array('cate_id' => $vo['id'],'mode_id' => $vo['mode_id'])); ?>"><?php echo $vo['cate_name']; ?></a>
                                                    <a href="<?php echo url('add',array('id' => $vo['id'])); ?>" style="float:right;" class="btn btn-sm btn-azure btn-addon"><i class="fa fa-plus"></i> 添加子栏目</a>
                                                </td>
                                                <td align="center">
                                                    <?php if($vo['status'] == 0): ?>
                                                    <a href="javascript:;" data-id="<?php echo $vo['id']; ?>" class="btn btn-danger btn-sm shiny" onclick="changeStatus(this)">隐藏</a>
                                                    <?php else: ?>
                                                    <a href="javascript:;" data-id="<?php echo $vo['id']; ?>" class="btn btn-primary btn-sm shiny" onclick="changeStatus(this)">显示</a>
                                                    <?php endif; ?>
                                                </td>
                                                <td align="center">
                                                ...
                                                <td align="center">
                                                    <input type="text" name="sort[<?php echo $vo['id']; ?>]" value="<?php echo $vo['sort']; ?>" style="width: 20%;text-align: center">
                                                </td>
                                                <td align="center">
...
<script>
    function changeStatus(obj) {
        ...
        $.ajax({
          type : "POST",
          dataType : "json",
          url : "<?php echo url('Category/changeStatus'); ?>",
          data : {id : id},
    ...
    $(".open_icon").click(function () {
        ...
        if($(this).text() == "+") {
            ...
            $.ajax({
                ...
                dataType : "json",
                data : {id : id},
                url : "<?php echo url('Category/ajaxList'); ?>",
