<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\Ian\wamp\www\cms\public/../application/admin\view\model_field\add.html";i:1556494713;s:58:"D:\Ian\wamp\www\cms\application\admin\view\public\top.html";i:1535515250;s:59:"D:\Ian\wamp\www\cms\application\admin\view\public\left.html";i:1556496660;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                                    ...
                                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                        <div class="tabbable">
                                            <ul class="nav nav-tabs  tabs-flat">
                                                <li class="active ">
                                                    <a data-toggle="tab" href="#FlatTab-1">添加字段</a>
                                                </li>
                                            </ul>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select name="mode_id" class="form-control">
                                                                <?php if(is_array($mode) || $mode instanceof \think\Collection || $mode instanceof \think\Paginator): $i = 0; $__LIST__ = $mode;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
