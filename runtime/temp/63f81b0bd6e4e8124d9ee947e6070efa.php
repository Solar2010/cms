<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\Ian\wamp\www\cms\public/../application/admin\view\model\edit.html";i:1556027020;s:58:"D:\Ian\wamp\www\cms\application\admin\view\public\top.html";i:1535515250;s:59:"D:\Ian\wamp\www\cms\application\admin\view\public\left.html";i:1555855074;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" name="old_table_name" value="<?php echo $model['table_name']; ?>">
                                        <div class="tabbable">
                                            <ul class="nav nav-tabs  tabs-flat">
                                                <li class="active ">
                                                    <a data-toggle="tab" href="#FlatTab-1">修改模型</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content  tabs-flat">
                                                <div class="active tab-pane" id="FlatTab-1">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" name="model_name" value="<?php echo $model['model_name']; ?>">
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" name="table_name" value="<?php echo $model['table_name']; ?>">
                                                        </div>
                                                        <p class="help-block col-sm-4 red">* 必填</p>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="checkbox">
                                                                <label>
                                                                    <input <?php if($model['status'] == 1): ?>checked="checked"<?php endif; ?> class="checkbox-slider  colored-blue" name="status" type="checkbox" value="1">
